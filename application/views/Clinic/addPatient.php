            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <?php echo form_input(['class'=>'form-control','placeholder'=>'Enter last name',
                        'name'=>'p_lastName','value'=>set_value('p_lastName')])?>
                    <?php echo form_error('p_lastName')?>
                </div>
                <div class="form-group">
